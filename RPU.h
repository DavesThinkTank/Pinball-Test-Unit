...
//   Solenoids
void RPU_PushToSolenoidStack(byte solenoidNumber, byte numPushes, boolean disableOverride = false, byte relay = 99);
...
void RPU_UpdateTimedSolenoidStack(unsigned long curTime, byte relay = 99);
...
void RPU_SetDisplayCredits(int value, boolean displayOn = true, boolean showBothDigits=true, boolean sixdigits=true);
...
void RPU_SetDigitFlashCredits(int digit, unsigned long curTime, int period, boolean sixdigits=1);
void RPU_SetDigitFlashBallInPlay(int digit, unsigned long curTime, int period, boolean sixdigits=1);
